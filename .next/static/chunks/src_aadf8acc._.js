...
"[project]/src/app/announcement/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Announcement.useEffect": ()=>{
            fetch('/api/events').then({
                "Announcement.useEffect": (res)=>res.json()
            }["Announcement.useEffect"]).then({
                "Announcement.useEffect": (data)=>setDataAcara(data)
            }["Announcement.useEffect"]).catch({
                "Announcement.useEffect": (err)=>console.log(err)
            }["Announcement.useEffect"]);
        }
    }["Announcement.useEffect"], []);
...
_s(Announcement, "9RFsok/4U7X9SdGx1q58nCDANis=");
_c = Announcement;
var _c;
...
//# sourceMappingURL=src_aadf8acc._.js.map