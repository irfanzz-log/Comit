...
async function GET(req) {
    ...
    try {
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token);
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT u.id, u.user_npm, password, u.user_role, ui.nama FROM users u JOIN users_info ui ON u.id = ui.user_id WHERE u.user_npm = $1', [
            payload.npm
        ]);
        const user = res.rows[0];
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "From auth/me: User not found"
            }, {
                status: 401
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9f6a82b9._.js.map