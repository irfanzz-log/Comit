module.exports = [
"[project]/.next-internal/server/app/api/userSearch/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/userSearch/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(// Pastikan menggunakan alias 'id' agar sesuai dengan 'user.id' di frontend
        'SELECT user_id AS id, nama FROM users_info WHERE nama ILIKE $1 LIMIT 5', [
            `%${q}%`
        ]);
        // Kirim array-nya saja langsung
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(res.rows);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__108cba37._.js.map